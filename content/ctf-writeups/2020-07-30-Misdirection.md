...
![Misdirection threader3000](/images/Misdirection1.png)

Next, let's run `nmap -A p- 22,80,3306,8080 [machine ip]` to further enumerate these ports.

![Misdirection nmap](/images/Misdirection2.png)
...
![Misdirection gobuster port 80](/images/Misdirection7.png)
...
![Misdirection python3 http.server](/images/Misdirection13.png)
...
![Misdirection root privesc](/images/Misdirection20.png)

Now, just run `cd /root`, followed by **ls** and then finally `cat root.txt` to get the final flag.

![Misdirection root.txt](/images/Misdirection21.png)
