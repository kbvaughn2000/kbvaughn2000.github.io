...
UltraTech is a medium difficulty box on [TryHackMe](https://www.tryhackme.com). Below are the steps I took to fully compromise this box.
...
![UltraTech nmap1](/images/UltraTech1.png)
...
![UltraTech nmap2](/images/UltraTech2.png)
...
![UltraTech gobuster](/images/UltraTech3.png)
...
![UltraTech api.js](/images/UltraTech5.png)
...
![UltraTech auth](/images/UltraTech6.png)
...
![UltraTech node.js command injection whoami](/images/UltraTech7.png)

Success! It returned a user of **www**. Next, let's see what's in the current directory with **http://[machine ip]:8081/ping?ip=\`ls\`**.

![UltraTech node.js command injection ls](/images/UltraTech8.png)
...
![UltraTech node.js command injection cat](/images/UltraTech9.png)

This provides you with the hashes for two users, **r00t**, and **admin**. The hash for r00t is the answer to **Question 2** for Task 3, let's save their hashes to a text file named **hashes.txt**, one per line and see if we can crack them. Once saved, let's run the following command `john hashes.txt --format=Raw-MD5 --wordlist=/usr/share/wordlists/rockyou.txt`.

![UltraTech john](/images/UltraTech10.png)
...
![UltraTech linpeas.sh](/images/UltraTech13.png)
...
![UltraTech docker image ls](/images/UltraTech14.png)
