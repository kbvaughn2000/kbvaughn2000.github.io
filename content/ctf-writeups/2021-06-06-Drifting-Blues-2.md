...
![Drifting Blues 2 netdiscover](/images/driftingblues-2-1.png)
...
![Drifting Blues 2 threader3000](/images/driftingblues-2-2.png)

Once prompted, let nmap run it's default scan that is built in to threader3000.

![Drifting Blues 2 nmap](/images/driftingblues-2-3.png)
...
![Drifting Blues 2 FTP](/images/driftingblues-2-4.png)
...
![Drifting Blues 2 initial website](/images/driftingblues-2-5.png)
...
![driftingblues-2-6](/images/driftingblues-2-6.png)
...
![Drifting Blues 2 /blog/ website](/images/driftingblues-2-7.png)
...
![Drifting Blues 2 /etc/hosts edit](/images/driftingblues-2-8.png)

I then reloaded the website to see if it updated the appearance:

![Drifting Blues 2 /blog/ website properly loaded](/images/driftingblues-2-9.png)
...
![Drifting Blues 2 WPScan 1](/images/driftingblues-2-10.png)

![Drifting Blues 2 WPScan 2](/images/driftingblues-2-11.png)

![Drifting Blues 2 WPScan 3](/images/driftingblues-2-12.png)
...
![Drifting Blues 2 WPScan 4](/images/driftingblues-2-13.png)

![Drifting Blues 2 WPScan 5](/images/driftingblues-2-14.png)
...
![Drifting Blues 2 WordPress Login](/images/driftingblues-2-15.png)
...
![Drifting Blues 2 WordPress edit theme](/images/driftingblues-2-16.png)
...
![Drifting Blues 2 Pentestmonkey Reverse PHP Shell](/images/driftingblues-2-17.png)



![Drifting Blues 2 WordPress overwrite 404 Template](/images/driftingblues-2-18.png)
...
![Drifting Blues 2 enumerate /home directory](/images/driftingblues-2-23.png)

Next, I used cat to display the contents of the **id_rsa** file with:

**`cat id_rsa`**

![Drifting Blues 2 cat id_rsa](/images/driftingblues-2-24.png)

I then highlighted and copied this and saved it to a file on my attacker box:

![Drifting Blues 2 save id_rsa key locally](/images/driftingblues-2-25.png)
...
![Drifting Blues 2 SSH](/images/driftingblues-2-26.png)
...
![Drifting Blues 2 user flag](/images/driftingblues-2-27.png)

Next, I decided to see what sudo permissions freddie had, if any, so I ran:

**`sudo -l`**

![Drifting Blues 2 sudo -l](/images/driftingblues-2-28.png)
...
![Drifting Blues 2 GTFOBins nmap privesc](/images/driftingblues-2-29.png)
...
![Drifting Blues 2 root flag](/images/driftingblues-2-30.png)
