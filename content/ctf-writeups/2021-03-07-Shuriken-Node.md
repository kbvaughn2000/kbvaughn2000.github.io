...
Shuriken:Node is a recently released box on [Vulnhub](https://www.vulnhub.com/entry/shuriken-node,628/) by TheCyb3rW0lf. It is rated as an easy/medium difficulty box. 

Once imported, I run the following to discover the IP address of the system:

**`netdiscover -i eth0`**

![Shuriken - netdiscover](/images/Shuriken1.png)
...
![Shuriken - threader3000](/images/Shuriken2.png)
...
![Shuriken - website1](/images/Shuriken3.png)
...
![Shuriken - decode cookie](/images/Shuriken6.png)
...
![Shuriken reencode cookie](/images/Shuriken7.png)

Let's reload the page and see what happens.

![Shuriken revisit webpage](/images/Shuriken8.png)
...
![Shuriken nodejsshell.py](/images/Shuriken9.png)
...
![Shuriken modify cookie](/images/Shuriken10.png)
...
![Shuriken upgrade shell](/images/Shuriken15.png)
...
![Shuriken python3 http.server](/images/Shuriken16.png)
...
![Shuriken linpeas download](/images/Shuriken17.png)
...
![Shuriken ssh-key.zip](/images/Shuriken18.png)
...
![Shuriken ssh-backup.zip permissions](/images/Shuriken19.png)

It appears we have read only access to this file. Let's copy it to our current user's home directory with: 

**`cp ssh-backup.zip ~/`**

![Shuriken copy ssh-backup.zip file](/images/Shuriken20.png)
...
![Shuriken inflate ssh-backup file](/images/Shuriken21.png)
...
![Shuriken python SimpleHTTPServer](/images/Shuriken22.png)

On our attacker host, let's run the following command:

**`wget http://<victim ip>:9000/id_rsa`**

![Shuriken save id_rsa](/images/Shuriken23.png)
...
![Shuriken ssh2john](/images/Shuriken24.png)
...
![Shuriken john ssh password](/images/Shuriken25.png)
...
![Shuriken locate shuriken-auto.timer](/images/Shuriken29.png)
...
![Shuriken view shuriken-auto.timer permissions](/images/Shuriken30.png)
...
![Shuriken edit timer](/images/Shuriken31.png)
...
![Shuriken edit service](/images/Shuriken32.png)
...
![Shuriken modify sudoers](/images/Shuriken33.png)

Next, let's make this script executable with:

**`chmod +x test.sh`**

![Shuriken chmod +x test.sh](/images/Shuriken34.png)
...
![Shuriken sudoers permission change](/images/Shuriken35.png)
...
![Shuriken modify /etc/sudoers](/images/Shuriken36.png)
...
![Shuriken revert /etc/sudoers permissions](/images/Shuriken37.png)

After a minute, the permissions should revert back to the appropriate level.

![Shuriken sudoers file permissions reverted](/images/Shuriken38.png)
...
![Shuriken rooted](/images/Shuriken39.png)
