...
![Overpass Downloads page](/images/Overpass3.png)
...
![Overpass source code 1](/images/Overpass4.png)
...
![Overpass source code 2](/images/Overpass5.png)
...
![Overpass gobuster](/images/Overpass6.png)

Let's take a look at this page and see what's there.

![Overpass website admin](/images/Overpass7.png)
...
![Overpass admin source code](/images/Overpass8.png)
...
![Overpass login.js source code](/images/Overpass9.png)
...
![Overpass console SessionToken cookie](/images/Overpass10.png)

This created a cookie named **SessionToken**, let's refresh the **/admin** page and see what happens.

![Overpass admin login RSA](/images/Overpass11.png)
...
![Overpass private rsa key](/images/Overpass12.png)
...
![Ovverpass ssh2john.py](/images/Overpass13.png)
...
![Overpass crack rsa key password](/images/Overpass14.png)
...
![Overpass james SSH](/images/Overpass15.png)
...
![Overpass user.txt](/images/Overpass16.png)
...
![Overpass .overpass](/images/Overpass17.png)
...
![Overpass cyberchef](/images/Overpass18.png)
...
![Overpass sudo -l](/images/Overpass19.png)
...
![Overpass python3 http server](/images/Overpass20.png)
...
![Overpass wget linpeas.sh](/images/Overpass21.png)
...
![Overpass linpeas cronjob](/images/Overpass22.png)

Let's run `cat /etc/crontab` to confirm that this is indeed in the system-wide crontab file.

![Overpass system crontab](/images/Overpass23.png)
...
![Overpass ping overpass.thm](/images/Overpass24.png)

It returns the localhost IP. Let's navigate to `cd /etc` and run `ls -al|grep hosts`.

![Overpass /etc/hosts permissions](/images/Overpass25.png)
...
![Overpass modify /etc/hosts](/images/Overpass26.png)

Next, let's run `ping overpass.thm` to ensure it returns our attacker's IP address.

![Overpass ping overpass.thm](/images/Overpass27.png)
...
![Overpass root.txt](/images/Overpass32.png)
