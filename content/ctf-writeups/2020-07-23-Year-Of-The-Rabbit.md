...
![Year of the Rabbit gobuster](/images/YearOfTheRabbit4.png)
...
![Year of the Rabbit assets directory](/images/YearOfTheRabbit5.png)

The **style.css** page provides you with the next place you are supposed to take a look, **/sup3r_s3cr3t_fl4g.php**

![Year of the Rabbit style.css](/images/YearOfTheRabbit6.png)

Visiting the **/sup3r_s3cr3t_fl4g.php** page provides you with the following popup:

![Year of the Rabbit Sup3r_s3cr3t_fl4g.php](/images/YearOfTheRabbit7.png)
...
![Year of the Rabbit sup3r_s3cr3t_fl4g no JavaScript](/images/YearOfTheRabbit8.png)
...
![Year of the Rabbit Intermediary.php hidden directory](/images/YearOfTheRabbit9.png)

Copying and pasting this directory gives us another directory with an image in it.

![Year of the Rabbit hidden directory](/images/YearOfTheRabbit10.png)
...
![Year of the Rabbit Hot_Babe.png hidden ftp](/images/YearOfTheRabbit12.png)
...
![Year of the Rabbit hydra](/images/YearOfTheRabbit13.png)
...
![Year of the Rabbit Eli's Creds](/images/YearOfTheRabbit14.png)
...
![Year of the Rabbit Brainfuck decoded](/images/YearOfTheRabbit15.png)
...
![Year of the Rabbit ssh access](/images/YearOfTheRabbit16.png)
...
![Year of the Rabbit s3cr3t directory](/images/YearOfTheRabbit17.png)

Let's run `cat .th1s_m3ss4ag3_15_f0r_gw3nd0l1n3_0nly!` to view it's contents. this will give us **gwendoline's password**.

![Year of the Rabbit gwendoline's password](/images/YearOfTheRabbit18.png)
...
![Year of the Rabbit user.txt](/images/YearOfTheRabbit19.png)
...
![Year of the Rabbit sudo -l](/images/YearOfTheRabbit20.png)
...
![Year of the Rabbit vi as root](/images/YearOfTheRabbit21.png)

Awesome, we were able to open vi, let's hit escape and enter `!bin/sh` and see who we get a shell as.

![Year of the Rabbit root shell](/images/YearOfTheRabbit22.png)
