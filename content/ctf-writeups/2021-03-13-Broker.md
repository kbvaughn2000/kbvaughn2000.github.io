...
![Broker Question 1](/images/Broker1.png)
...
![Broker threader3000](/images/Broker2.png)

### Question 2

The second question for this room was the following:

![Broker Question 2](/images/Broker3.png)
...
![Broker nmap](/images/Broker4.png)

### Question 3

The third question is asking for the following:

![Broker Question 3](/images/Broker5.png)
...
![Broker MQTT.fx website](/images/Broker6.png)
...
![Broker MQTT.fx connection configuration](/images/Broker7.png)
...
![Broker ActiveMQ default credentials](/images/Broker8.png)

I attempted the admin/admin credentials and was successful in connecting!

![Broker MQTT.fx credentials](/images/Broker9.png)

![Broker successful connection](/images/Broker10.png)
...
![Broker Subscribe scan](/images/Broker11.png)
...
![Broker video game name](/images/Broker12.png)
...
![Broker ActiveMQ website](/images/Broker13.png)
...
![Broker admin login](/images/Broker14.png)

Once logged in, the main page displays the version number: **5.9.0**.

![Broker ActiveMQ version](/images/Broker15.png)
...
![Broker /fileserver directory](/images/Broker16.png)
...
![Broker Burp Suite Target](/images/Broker17.png)
...
![Broker CyberChef](/images/Broker18.png)
...
![Broker upload shell Burp](/images/Broker19.png)
...
![Broker return directory path Burp](/images/Broker20.png)
...
![Broker move jsp shell](/images/Broker21.png)
...
![Broker enter nc reverse shell](/images/Broker25.png)

You should now have a foothold into this system!

![Broker initial foothold](/images/Broker26.png)
...
![Broker which python3](/images/Broker27.png)
...
![Broker upgraded shell](/images/Broker28.png)
...
![Broker sudo -l](/images/Broker32.png)
...
![Broker ls -al](/images/Broker33.png)
...
![Broker echo reverse shell](/images/Broker34.png)
...
![Broker cat subscribe.py](/images/Broker35.png)
...
![Broker nc listener for root shell](/images/Broker36.png)
...
![Broker sudo python3](/images/Broker37.png)

We should now have a shell as root on the listener on port 4242

![Broker root shell](/images/Broker38.png)
...
![Broker root.txt flag](/images/Broker39.png)
