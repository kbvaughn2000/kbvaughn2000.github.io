...
![Vulnix netdiscover](/images/Vulnix1.png)

Next, I ran `threader3000` to let is enumerate the open ports. I also let it run it's recommended nmap scan.

![Vulnix threader3000](/images/Vulnix2.png)

![Vulnix nmap 1](/images/Vulnix3.png)

![Vulnix nmap 2](/images/Vulnix4.png)
...
![Vulnix smpt-user-enum](/images/Vulnix5.png)
...
![Vulnix finger](/images/Vulnix6.png)
...
![Vulnix hydra ssh brute force](/images/Vulnix7.png)
...
![Vulnix root ssh-keygen](/images/Vulnix10.png)
...
![Vulnix public RSA key](/images/Vulnix11.png)
...
![Vulnix vulnix .ssh folder](/images/Vulnix12.png)
...
![Vulnix /etc/exports modification](/images/Vulnix16.png)
