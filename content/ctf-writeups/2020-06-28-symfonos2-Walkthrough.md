...
layout: "writeup"
difficulty: "Medium"
excerpt: "Walkthrough for the symfonos 2 VM"
os: "Linux"
platform: "VulnHub"
...
![symfonos2 nmap smb-enum-shares](/images/symfonos2-4.png)
...
![symfonos2 smbclient pilfering](/images/symfonos2-5.png)
...
![symfonos2 log.txt](/images/symfonos2-6.png)
![symfonos2 log.txt](/images/symfonos2-7.png)
...
![symfonos2 ftp attempt](/images/symfonos2-8.png)

Reviewing the log file a bit further we come across a user account **aeolus**.

![symfonos2 log.txt](/images/symfonos2-9.png)
...
![symfonos2 aeolus password](/images/symfonos2-10.png)

We were able to successfully authenticate with these credentials via **ssh**.

![symfonos2 aeolus password](/images/symfonos2-11.png)
...
![symfonos2 python http server](/images/symfonos2-12.png)
![symfonos2 wget](/images/symfonos2-13.png)

Next, we have to make the script executable, which can be done with `chmod 777 LinEnum.sh`

![symfonos2 wget](/images/symfonos2-14.png)
...
![symfonos2 wget](/images/symfonos2-15.png)
...
![symfonos2 librenms](/images/symfonos2-16.png)
...
![symfonos2 searchsploit](/images/symfonos2-17.png)
...
![symfonos2 ssh local port forwarding](/images/symfonos2-18.png)

Now we should be able to view this site from a web browser at http://127.0.0.1:8080/

![symfonos2 librenms login](/images/symfonos2-19.png)

Let's try logging in with **aeolus** credentials we uncovered earlier.

![symfonos2 librenms login](/images/symfonos2-20.png)
...
![symfonos2 msfconsole librenms exploit](/images/symfonos2-21.png)
...
![symfonos2 msfconsole shell](/images/symfonos2-22.png)
...
![symfonos2 interactive shell](/images/symfonos2-23.png)

Let's run `sudo -l` and see if **cronos** has access to run any programs as root.

![symfonos2 sudo -l](/images/symfonos2-24.png)
...
![symfonos2 GTFOBins](/images/symfonos2-25.png)

Let's run it and see what happens.

![symfonos2 root shell](/images/symfonos2-26.png)

It worked! Now you just have to navigate to the root home directory and `cat proof.txt`

![symfonos2 root proof.txt](/images/symfonos2-27.png)
