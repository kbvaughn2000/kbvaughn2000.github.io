...
![Brainstorm Task 1 Question 2](/images/Brainstorm1.png)
...
![Brainstorm threader3000](/images/Brainstorm2.png)
...
![Brainstorm Task 2 Question 1 nmap](/images/Brainstorm3.png)
...
![Brainstorm Anonymous FTP](/images/Brainstorm4.png)
...
![Brainstorm download FTP file](/images/Brainstorm5.png)
...
![Brainstorm Copy Files Kali Box](/images/Brainstorm6.png)

Next, on the Windows machine, paste the files (this should work if you allow copy/paste over RDP).

![Brainstorm Paste to Windows system](/images/Brainstorm7.png)
...
![Brainstorm Immunity Debugger Attach chatserver](/images/Brainstorm8.png)

Next, let's click on the red arrow to run Immunity Debugger.

![Brainstorm run Immunity Debugger](/images/Brainstorm9.png)
...
![Brainstorm nc chat server](/images/Brainstorm10.png)
...
![Brainstorm buffer overflow](/images/Brainstorm12.png)
...
![Brainstorm overwrite EIP ESP](/images/Brainstorm13.png)    
...
![Brainstorm pattern_create.rb](/images/Brainstorm14.png)
...
![Brainstorm EIP Value](/images/Brainstorm15.png)
...
![Brainstorm offset](/images/Brainstorm16.png)
...
![Brainstorm Mona Modules](/images/Brainstorm17.png)
...
![Brainstorm search for JMP ESP](/images/Brainstorm18.png)
...
![Brainstorm Immunity Toolbar](/images/Brainstorm19.png)

Next enter the memory address (625014df) uncovered above.

![Brainstorm jump to 62501df](/images/Brainstorm20.png)

Next, press **F2** to set a breakpoint here and ensure that running is showing in the lower right hand corner.

![Brainstorm Immunity Debugger Breakpoint](/images/Brainstorm21.png)
...
![Brainstorm confirm JMP ESP Value](/images/Brainstorm22.png)
...
![Brainstorm shellcode](/images/Brainstorm23.png)
...
![Brainstorm netcat](/images/Brainstorm24.png)

Next, run the script and we should catch a shell on the netcat listener.

![Brainstorm shell on victim](/images/Brainstorm25.png)
...
![Brainstorm enumerate user directory](/images/Brainstorm26.png)
...
![Brainstorm root](/images/Brainstorm27.png)
